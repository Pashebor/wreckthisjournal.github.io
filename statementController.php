...
$message = "<b>Заявка от клиента: <b>".$mailName.' <br></br> <b>
Его почта: '.$mailEmail.'
...
if(isset($state)){
    ...
    $query = mysql_query("insert into statements(name, email,  phone) values ('$name', '$email', '$phone')");
...
<body>
    <div class='answerCircle' style='margin-top: 150px'>
        ...
        <p style='font-family: Firenight; font-size: 13pt; color: #000000 '>Благодарим Вас!
            Ваша заявка будет рассмотрена в течении 12-ти часов, и наш оператор свяжется с вами по электронной почте,
            либо по телефону:))))</p>
